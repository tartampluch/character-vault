...
export const UI_STRINGS: Record<string, UiStringValue> = {
  ...
  'magic.casting.scrolls':        'Scrolls',
   ...
   // Summoned entities panel (SummonedEntitiesPanel.svelte)
  'magic.summon.panel_title':         'Summoned Entities',
  'magic.summon.panel_count_aria':    '{n} summoned entities active',
  'magic.summon.from_spell':          'from',
  'magic.summon.dismiss':             'Dismiss',
  'magic.summon.dismiss_tooltip':     'Dismiss this summoned entity',
  'magic.summon.confirm_dismiss':     'End this summon?',
  'magic.summon.info_title':          'Spell details',
  'magic.summon.info_aria':           'Show details for {name}',
  'magic.summon.entity_type.summon':  'Summon',
  'magic.summon.entity_type.companion': 'Companion',
  'magic.summon.entity_type.familiar': 'Familiar',
  'magic.summon.entity_type.mount':   'Mount',
  'magic.summon.entity_type.undead':  'Undead',
  'magic.summon.entity_type.object':  'Created Object',
  // Localized names for spell-created entities (referenced by castEffect.nameKey)
  'magic.summon.spiritual_weapon':    'Spiritual Weapon',
  'magic.summon.nature_ally':         'Nature\'s Ally',
  'magic.summon.mages_sword':         'Mage\'s Sword',
  'magic.summon.summon_monster':      'Summoned Monster',
  'magic.summon.mount':               'Summoned Mount',
  'magic.summon.phantom_steed':       'Phantom Steed',
  'magic.summon.unseen_servant':      'Unseen Servant',
  'magic.summon.tiny_hut':            'Tiny Hut',
  'magic.summon.secure_shelter':      'Secure Shelter',
  'magic.summon.magnificent_mansion': 'Magnificent Mansion',
  'magic.summon.zombie':              'Zombie',
  'magic.summon.skeleton':            'Skeleton',
  'magic.summon.animated_object':     'Animated Object',
  'magic.summon.shambler':            'Shambling Mound',
  'magic.summon.swarm':               'Swarm',
  'magic.summon.instrument':          'Musical Instrument',
